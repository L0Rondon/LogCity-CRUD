...
app.get('/tarefas', (req, res) => res.sendFile(path.join(__dirname, 'public', 'cadastroOni.html')));
app.get('/responsaveis', (req, res) => res.sendFile(path.join(__dirname, 'public', 'responsaveis.html')));
app.get('/listartarefas', (req, res) => res.sendFile(path.join(__dirname, 'public', 'ListarLinhas.html')));
...
app.get('/api/tarefas', (req, res) => {
  fs.readFile(path.join(__dirname, 'data', 'linhas.json'), 'utf8', (err, data) => {
    if(err) return res.json({ success:false });
    const arr = JSON.parse(data||'[]');
...
app.post('/tarefas', (req, res) => {
  ...
  const fileT = path.join(__dirname, 'data', 'linhas.json');
